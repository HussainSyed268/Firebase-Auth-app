...
const Dashboard = () => {
    return (
        <div className="flex flex-col bg-[#f4f4f4] h-[91vh]">
            ...
            <div className=" grid grid-cols-4 gap-10 h-[40vh] w-11/12 mt-10 mx-auto bg-[#f4f4f4]">
            ...
            <div className="grid grid-cols-4 gap-10 h-[32vh] w-11/12 mt-10 mx-auto bg-[#f4f4f4]">
